...
# FFMPEG flags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1 -I/usr/bin/include   
FFMPEG_LDFLAGS =   -pthread -L/usr/bin/lib -lavformat -lavcodec -lz -lrt -ldl -lswscale -lavutil -lm  
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lm -lrt -lpthread  -lasound -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lpthread  -pthread -L/usr/bin/lib -lavformat -lavcodec -lz -lrt -ldl -lswscale -lavutil -lm   -lv4l2
