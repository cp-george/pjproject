...
#export TEST_LDFLAGS += -L/usr/local/lib/ -lm -lrt -lpthread  -lasound -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lpthread  -pthread -L/usr/bin/lib -lavformat -lavcodec -lz -lrt -ldl -lswscale -lavutil -lm   -lv4l2
